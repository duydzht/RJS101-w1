...
function RenderStaff({ staff, handleDelete, editStaff }) {
  //format values date
  staff.doB = moment(staff.doB).format("YYYY-MM-DD");
  staff.startDate = moment(staff.startDate).format("YYYY-MM-DD");
  ...
  return (
    <div className="container">
      <div className="row mb-5">
        ...
        <div className="col-12 col-md-8 col-lg-9 border border-white text-warning rounded">
          <Stagger in>
            <div className="d-flex justify-content-between mt-3">
              ...
              <div className="d-flex">
                <button
                  ...
                  onClick={() => handleClick()} // gọi hàm sửa ở đây
                >
                  Sửa
                </button>
                <button
                  ...
                  onClick={() => handleDelete(staff.id)} // gọi hàm xóa ở đây
                >
                  Xóa
                </button>
              </div>
...
const StaffDetail = (props) => {
  ...
  const handleDelete = (id) => {
    if (confirm("CẢNH BÁO: Bạn chắc chắn muốn xóa nhân viên này?")) { //eslint-disable-line
      props.deleteStaff(id); // gọi đến hàm xóa ở component Main truyền sang
      props.history.push("/stafflist"); // xóa xong thì điều hướng về amfn staff list
    };
  };
  if (props.isLoading) {
    return (
    ...
    return (
      <div className="container">
        ...
        <div>
          <RenderStaff
            staff={props.staff}
            handleDelete={handleDelete} // truyền hàm handleDelete vào component RenderStaff
